...
```{r, fig.width = 8, fig.height = 6, fig.alt = "Boxplots showing the distribution of the top 10 informative landscape metrics across different spatial patterns", fig.cap = "Distribution of the top 10 informative landscape metrics across different spatial patterns. Each dot is a landscape, the boxplots show the distribution of metric values for each spatial pattern."}
plot_metrics(
  landscape_metrics,
