...
- Visualize multiple landscapes in a grid with `plot_landscapes()`
...
plot_landscapes(list(random, bare, dense), show_legend = FALSE)
```
...
plot_landscapes(list(spots, gaps, labyrinth), show_legend = FALSE)
```
...
plot_landscapes(list(labyrinth_default, labyrinth_complex), titles = "name")
```
