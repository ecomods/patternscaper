...
evaluation$selected
#> [1] "area_mn"  "np"       "dcore_sd" "para_cv"  "division"
...
#>  1 area_mn  Patch area (mean)       0.776     1 TRUE     select… NA             
#>  2 dcad     Disjunct core area den… 0.776     2 FALSE    droppe… area_mn        
#>  3 ndca     Number of disjunct cor… 0.776     3 FALSE    droppe… area_mn        
#>  4 np       Number of patches       0.776     4 TRUE     select… NA             
#>  5 pd       Patch density           0.776     5 FALSE    droppe… np             
#>  6 dcore_cv Disjunct core area (CV) 0.762     6 FALSE    droppe… area_mn, np    
#>  7 dcore_sd Disjunct core area (SD) 0.762     7 TRUE     select… NA             
#>  8 ai       Aggregation index       0.758     8 FALSE    droppe… area_mn, dcore…
#>  9 area_cv  Patch area (CV)         0.758     9 FALSE    droppe… area_mn, np    
#> 10 area_sd  Patch area (SD)         0.758    10 FALSE    droppe… area_mn        
#> # ℹ 56 more rows
...
#>   <fct>                  <int>
#> 1 selected                   5
#> 2 dropped_correlated        36
#> 3 dropped_below_cutoff      16
