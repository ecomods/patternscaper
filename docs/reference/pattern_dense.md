...
- veg_prob:
  ...
  Numeric. Probability that each cell is vegetated (0-1, default: 0.9).
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, veg_prob = 0.923331122461241 
#> 
#> $dense_2
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, veg_prob = 0.943807370495051 
#> 
#> $dense_3
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, veg_prob = 0.960781267285347 
#> 
#> $dense_4
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, veg_prob = 0.890634597546887 
#> 
```
