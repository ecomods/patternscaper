...
- architecture:
  ...
  return a new uncompiled Keras model each time it is called.
...
#>       4       4       4 
#> Warning: Cannot maintain 3 samples per class per fold (smallest class: 4). Switching to
#> LOO CV.
#> 
#> ── Cross-validation (loo, 12 folds) ──
#> 
#> ✔ Fold 1/12 accuracy: 0
#> ✔ Fold 2/12 accuracy: 1
#> ✔ Fold 3/12 accuracy: 1
#> ✔ Fold 4/12 accuracy: 0
#> ✔ Fold 5/12 accuracy: 1
#> ✔ Fold 6/12 accuracy: 1
#> ✔ Fold 7/12 accuracy: 1
#> ✔ Fold 8/12 accuracy: 1
#> ✔ Fold 9/12 accuracy: 0
#> ✔ Fold 10/12 accuracy: 0
#> ✔ Fold 11/12 accuracy: 0
#> ✔ Fold 12/12 accuracy: 0
#> Warning: Some classes were never correctly predicted during evaluation: "diffuse".
#> Results for these classes are unreliable.
#> 
#> ── Cross-validation results ──
#> 
#> ℹ Method: leave-one-out cross-validation
...
#>   <chr>   <dbl>  <dbl>     <dbl>    <dbl>
#> 1 diffuse     4    0        0        0   
#> 2 random      4    1        0.44     0.62
#> 3 sharp       4    0.5      1        0.67
#> 
#> ── Accuracy and loss across folds ──
#> 
#> Mean accuracy: 0.5 +- 0.5222
#> Mean loss: 1.0705 +- 0.7415
#> 
#> 
#> ── Training final model on all data (validation split: 0) ──
#> 
#> Epoch 1 - loss: 1.0981 - accuracy: 0.3333
#> Epoch 2 - loss: 2.5735 - accuracy: 0.3333
#> Epoch 3 - loss: 1.1555 - accuracy: 0.3333
#> Epoch 4 - loss: 1.0341 - accuracy: 0.6667
#> Epoch 5 - loss: 0.9331 - accuracy: 0.3333
...
#> 
#> Epoch 1 - loss: 1.1080 - accuracy: 0.5000
#> Epoch 2 - loss: 2.1772 - accuracy: 0.3333
#> Epoch 3 - loss: 1.8030 - accuracy: 0.4167
#> Epoch 4 - loss: 1.2027 - accuracy: 0.3333
#> Epoch 5 - loss: 1.0253 - accuracy: 0.3333
```
