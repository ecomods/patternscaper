...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 9, gap_radius_sd = 1.45606348291039, radius_noise_fraction = 0.0571114751510322, regular_gaps = TRUE 
#> 
#> $gaps_2
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 9, gap_radius_sd = 0.508952034637332, radius_noise_fraction = 0.105594660714269, regular_gaps = TRUE 
#> 
#> $gaps_3
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 10, gap_radius = 7, gap_radius_sd = 0.622485519386828, radius_noise_fraction = 0.197597225476056, regular_gaps = TRUE 
#> 
#> $gaps_4
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 6, gap_radius_sd = 1.92483363021165, radius_noise_fraction = 0.0826474804896861, regular_gaps = TRUE 
#> 
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 8, gap_radius_sd = 0.292392518837005, radius_noise_fraction = 0.11464021326974, regular_gaps = TRUE 
#> 
#> $gaps_2
#> Landscape: "gaps_2" [pattern: gaps]
#> -----------------------------------------
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 10, gap_radius_sd = 0.315621483139694, radius_noise_fraction = 0.176460389979184, regular_gaps = FALSE 
#> 
#> $gaps_3
#> Landscape: "gaps_3" [pattern: gaps]
#> -----------------------------------------
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 5, gap_radius_sd = 1.9248610753566, radius_noise_fraction = 0.0511716902721673, regular_gaps = FALSE 
#> 
#> $gaps_4
#> Landscape: "gaps_4" [pattern: gaps]
#> -----------------------------------------
...
#> Extent    : xmin=0.0, xmax=100.0, ymin=0.0, ymax=100.0
#> Values    : min=0.0, max=1.0
#> Parameters: width = 100, height = 100, invert_landscape = TRUE, n_gaps = 6, gap_radius = 9, gap_radius_sd = 0.79781765723601, radius_noise_fraction = 0.058582017198205, regular_gaps = TRUE 
#> 
```
