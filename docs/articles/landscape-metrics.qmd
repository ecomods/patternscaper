...
sample_landscapes <- create_training_landscapes(
  n = 20,
...
To calculate selected metrics, provide a vector of valide metric names to the `metrics` argument. Find available metric names using `landscapemetrics::list_lsm()` as shown above.
...
- `krustkal_effsize`: Kruskal-Wallis H test effect sizes. Non-parametric test for differences between groups.
