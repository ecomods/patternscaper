...
The package provides 13 distinct landscape patterns divided into three
categories. Each pattern can be customized with specific parameters,
which we explore in detail below.

### Boundary Patterns

Represent transitions between two classes (e.g., forest and non-forest)
along boundaries:
...
![](pattern-showcase_files/figure-html/boundary-patterns-1.png)
...
![](pattern-showcase_files/figure-html/spatial-patterns-1.png)
...
![](pattern-showcase_files/figure-html/random-patterns-1.png)
...
\[description + manual parameter \[description + manual parameter
examples\]
