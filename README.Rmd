...
You can install the development version of patternscaper from [GitHub](https://github.com/ecomods/patternscaper) with:
...
[Get started](https://ecomods.github.io/patternscaper/articles/patternscaper.html)
...
To get a BibTex entry for citing, please use `citation("patternscaper")`.

## Contributing

Please see our [contributing guide](https://ecomods.github.io/patternscaper/CONTRIBUTING.html) for details on how to get involved.

## Code of Conduct

Please note that the patternscaper project is released with a [Contributor Code of Conduct](https://ecomods.github.io/patternscaper/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
